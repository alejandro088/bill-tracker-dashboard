...
.card.card-success {
  ...
  background: linear-gradient(to right, var(--color-success-light, rgba(76, 175, 80, 0.05)), transparent 50%);
}
...
.card.card-warning {
  ...
  background: linear-gradient(to right, var(--color-warning-light, rgba(255, 152, 0, 0.05)), transparent 50%);
}
...
.card.card-danger {
  ...
  background: linear-gradient(to right, var(--color-danger-light, rgba(244, 67, 54, 0.05)), transparent 50%);
}
